                                ...
                                >
                                    <FeaturedProjectWrapper project={project}>
                                        <div className="interactive-card relative h-full min-h-56 p-5 hover:bg-card/30 active:bg-card/30 md:min-h-80 md:p-8">
                                            ...
                                            <div className="absolute top-4 left-1 h-4 w-4 border-muted-foreground/20 border-t-2 border-l-2 transition-all duration-500 group-hover:h-6 group-hover:w-6 group-hover:border-primary/60 group-active:h-6 group-active:w-6 group-active:border-primary/60 md:left-4" />
                                            <div className="absolute top-4 right-1 h-4 w-4 border-muted-foreground/20 border-t-2 border-r-2 transition-all duration-500 group-hover:h-6 group-hover:w-6 group-hover:border-primary/60 group-active:h-6 group-active:w-6 group-active:border-primary/60 md:right-4" />
                                            <div className="absolute bottom-4 left-1 h-4 w-4 border-muted-foreground/20 border-b-2 border-l-2 transition-all duration-500 group-hover:h-6 group-hover:w-6 group-hover:border-secondary/60 group-active:h-6 group-active:w-6 group-active:border-secondary/60 md:left-4" />
                                            <div className="absolute right-1 bottom-4 h-4 w-4 border-muted-foreground/20 border-r-2 border-b-2 transition-all duration-500 group-hover:h-6 group-hover:w-6 group-hover:border-secondary/60 group-active:h-6 group-active:w-6 group-active:border-secondary/60 md:right-4" />
