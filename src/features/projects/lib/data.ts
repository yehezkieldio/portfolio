...
export const PROJECTS: Project[] = [
    ...
    },
    {
        id: "31",
        title: "ExynosNetwork",
        description: "Landing page for ExynosNetwork, a skyblock Minecraft Bedrock Edition server.",
        category: "Web Application",
        year: 2020,
        technologies: ["HTML", "CSS", "JavaScript"],
    ...
    },
    {
        id: "32",
        title: "PixelBedrock",
        description: "Landing page for PixelBedrock, a minigames Minecraft Bedrock Edition server.",
        category: "Web Application",
        year: 2020,
        technologies: ["HTML", "CSS", "JavaScript"],
        viewUrl: "https://gitlab.com/yehezkieldio/pixelbedrock",
        image: "/img_projects/32.png",
    },
    {
        id: "33",
        title: "BlazedBE",
        description: "Landing page for BlazedBE, a minigames Minecraft Bedrock Edition server.",
        category: "Web Application",
        year: 2019,
        technologies: ["HTML", "CSS", "JavaScript"],
